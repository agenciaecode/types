...
namespace Mkioschi\Tests\ValueObjects\UnitOfInformation;

use Mkioschi\ValueObjects\UnitOfInformation\Byte;
...
class ByteTest extends TestCase
{
    public function test_should_be_able_to_create_a_valid_byte()
    {
        ...
        $this->assertEquals('1 Byte', (new Byte(1))->getHumansFormat(false));
    }
